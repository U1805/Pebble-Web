...
import { loginWeb } from "../runtime/login";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {error && (
          <p role="alert" style={{ margin: "10px 0 0", fontSize: 13, color: "var(--color-danger, #dc2626)" }}>
            {error}
          </p>
        )}
        ...
        >
          {submitting ? t("login.signingIn", "Signing in…") : t("login.submit", "Sign in")}
        </button>
      </form>
    </div>
  );
